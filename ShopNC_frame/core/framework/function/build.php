...
//	}
	...
	$compile .= "\nBase::run();";
	file_put_contents(RUNCOREPATH,compress_code("<?php defined('IN_B2B2C') or exit('Access Invalid!');".$compile));
}
...
function compile($filename) {
    ...
    $content = str_ireplace("defined('IN_B2B2C') or exit('Access Invalid!')", '', $content);
