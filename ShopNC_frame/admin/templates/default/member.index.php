      ...
      <tbody>
        ...
        <tr class="hover member">
          ...
          <td class="align-center">
            <a href="index.php?act=member&op=member_edit&member_id=<?php echo $v['member_id']; ?>"><?php echo $lang['nc_edit']?></a> | <a href="index.php?act=notice&op=notice&member_name=<?php echo ltrim(base64_encode($v['member_name']),'='); ?>"><?php echo $lang['member_index_to_message'];?></a>  |
            <a href="index.php?act=member&op=distributermng&member_id=<?php echo $v['member_id']; ?>" ><span><?php echo $lang['member_be_distributer']; ?></span></a>  |
            <a href="index.php?act=member&op=community&member_id=<?php echo $v['member_id']; ?>&member_name=<?php echo $v['member_name']; ?>" ><?php if($v['is_o2o']){echo'<span style="color:green">'.$lang['member_index_community'].'</span>';}else{echo '<span>'.$lang['member_index_community'].'</span>';}?></a>
            | <a href="index.php?act=member&op=genqrcard&member_id=<?php echo $v['member_id']; ?>"><span style="color:#cd1717">生成二维码</span></a> 
          </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
