...
<div class="page">
  ...
  <form id="form" method="post" enctype="multipart/form-data" name="settingForm">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label for="sea_hot_search"><?php echo $lang['sea_hot_search'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input id="sea_hot_search" name="sea_hot_search" value="<?php echo $output['list_setting']['sea_hot_search'];?>" class="txt" type="text"></td>
          <td class="vatop tips"><span class="vatop rowform"><?php echo $lang['field_notice'];?></span></td>
        </tr>
      </tbody>
      <tfoot>
