...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=sea_article_class&op=article_class"><span><?php echo $lang['nc_manage'];?></span></a></li>
	...
	$('#article_class_form').validate({
        ...
        rules : {
            ac_name : {
                required : true,
                remote   : {
                url :'index.php?act=sea_article_class&op=ajax&branch=check_class_name',
                type:'get',
                data:{
                    ac_name : function(){
                        return $('#ac_name').val();
