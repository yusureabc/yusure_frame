...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['shake_joke_add'];?></h3>
      <ul class="tab-base">
  ...
  <form id="add_form" method="post" action="index.php?act=shake_joke&op=joke_add">
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
            <textarea name="joke_contents" id="joke_contents" rows="10"></textarea>
          </td> 
