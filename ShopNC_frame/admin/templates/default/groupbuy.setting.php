...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="<?php echo urlAdmin('groupbuy', 'groupbuy_setting_save');?>">
    ...
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation">团购价格:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform">
                <input type="text" id="groupbuy_price" name="groupbuy_price" value="<?php echo $output['setting']['groupbuy_price'];?>" class="txt">
            </td>
            <td class="vatop tips">团购套餐价格，单位为元，购买周期为月(30天)</td>
        </tr>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation">团购审核期:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform">
            ...
            <td class="vatop tips">团购审核期(天)，平台预留的审核天数，卖家只能发布审核期天数以后的团购活动</td>
        </tr>
      </tbody>
      <tfoot>
        <tr class="tfoot">
