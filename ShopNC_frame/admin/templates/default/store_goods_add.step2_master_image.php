<div class="goods-gallery add-step2"><a class='sample_demo' id="select_submit" href="index.php?act=sea_album&op=pic_list&item=goods" style="display:none;"><?php echo $lang['nc_submit'];?></a>
  ...
  <ul class="list">
    ...
    <li onclick="insert_img('<?php echo $v['apic_cover'];?>','<?php echo sea_thumb($v, 240);?>');"><a href="JavaScript:void(0);"><img src="<?php echo sea_thumb($v, 240);?>" title='<?php echo $v['apic_name']?>'/></a></li>
    <?php }?>
  </ul>
  <?php }else{?>
