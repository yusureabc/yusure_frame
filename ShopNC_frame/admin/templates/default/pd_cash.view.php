...
<div class="page">
  ...
  <form method="post" id="pdform" action="index.php">
  	...
  	<input type="hidden" name="op" value="pd_cash_refuse" >
  	<input type="hidden" name="flags" value="<?php echo $output['info']['pdc_id'];?>">
    <table class="table tb-type2 nobdb">
      ...
      <?php if (!intval($output['info']['pdc_payment_state'])) {?>
        ...
        <tr class="tfoot">
        <td colspan="2">
	        <a class="btn" href="javascript:if (confirm('<?php echo $lang['admin_predeposit_cash_confirm'];?>')){window.location.href='index.php?act=predeposit&op=pd_cash_pay&id=<?php echo $output['info']['pdc_id']; ?>';}else{}"><span><?php echo $lang['recharge_pass'];?></span></a>
