  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=sea_article_class&op=article_class_add" ><span><?php echo $lang['nc_new'];?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover edit">
          ...
          <td class="name"><span title="<?php echo $lang['nc_editable'];?>" required="1" fieldid="<?php echo $v['ac_id'];?>" ajax_branch='article_class_name' fieldname="ac_name" nc_type="inline_edit" class="editable "><?php echo $v['ac_name'];?></span> <a class='btn-add-nofloat marginleft' href="index.php?act=sea_article_class&op=article_class_add&ac_parent_id=<?php echo $v['ac_id'];?>"><span><?php echo $lang['nc_add_sub_class'];?></span></a></td>
          <td class="align-center"><a href="index.php?act=sea_article_class&op=article_class_edit&ac_id=<?php echo $v['ac_id'];?>"><?php echo $lang['nc_edit'];?></a>
            <?php if($v['ac_code'] == ''){?>
            | <a href="javascript:if(confirm('<?php echo $lang['article_class_index_ensure_del'];?>'))window.location = 'index.php?act=sea_article_class&op=article_class_del&ac_id=<?php echo $v['ac_id'];?>';"><?php echo $lang['nc_del'];?></a>
            <?php }?></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
...
<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.sea_article_class.js" charset="utf-8"></script> 
