  ...
  <form id="points_form" method="post" name="form1">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation"><?php echo $lang['currency_value']; ?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" id="currencynum" name="currencynum" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="currencydesc" rows="6" class="tarea"></textarea></td>
          <td class="vatop tips"><?php echo $lang['currency_help2'];?></td>
        </tr>
      </tbody>
      <tfoot>
        <tr class="tfoot">
...
function checkmember(){
	...
	$.getJSON("index.php?act=currency&op=checkmember", {'name':membername}, function(data){
	        if (data)
	        {
		        $("#tr_memberinfo").show();
				var msg= "<?php echo $lang['admin_points_member_tip']; ?> "+ data.name + "<?php echo $lang['currency_value']; ?>" + data.pb_amount;
