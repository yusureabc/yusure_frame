    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
            ...
            <td class="align-left"><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=show_store&store_id=<?php echo $val['store_id'];?>" target="_blank"><span><?php echo $val['store_name'];?></span></a></td>
