...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?act=o2o_area&op=area_drop');
        $('#area_id').val(id);
        $('#list_form').submit();
    }
}
  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
		...
		<li><a href="index.php?act=o2o_area&op=area_add"><span><?php echo $lang['nc_add'];?></span></a></li>
      </ul>
    </div>
  </div>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            <?php if($output['area_name'] != '' or $output['first_letter'] != ''){?>
            <a class="btns " href="index.php?act=o2o_area&op=arealist" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?>
          </td>
        </tr>
      </tbody>
    ...
    <table class="table tb-type2">
      <thead>
        ...
        <tr class="thead">
          ...
          <th><?php echo $lang['nc_admin_fullfirst_letter'];?></th>          
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td><?php echo $val['area_name']?>&nbsp;<a class="btn-add-nofloat marginleft" href="index.php?act=o2o_area&op=area_add&area_id=<?php echo $val['area_id'];?>"><span><?php echo $lang['nc_store_add_new_class'];?></span></a></td>
		  <td><?php echo $val['first_letter'];?></td>
      <td><?php echo $val['full_first_letter'];?></td>
		  ...
		  <td class='align-center'>
		  	<a href="index.php?act=o2o_area&op=area_edit&area_id=<?php echo $val['area_id'];?>"><?php echo $lang['nc_edit'];?></a> | 
...
<script type="text/javascript">
var ADMIN_TEMPLATES_URL = '<?php echo ADMIN_SITE_URL; ?>/templates/default';
