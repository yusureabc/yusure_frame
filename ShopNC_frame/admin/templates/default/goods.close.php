  ...
  <form method='post' id="form_goods" action="<?php echo urlAdmin('goods', 'goods_del');?>">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td class="w24"><input type="checkbox" name="id[]" value="<?php echo $v['goods_id'];?>" class="checkitem"></td>
          ...
          <td class="align-center">
            ...
            <?php if ($v['goods_state'] == 0) {?><p><?php echo $v['goods_stateremark'];?></p><?php }?>
          </td>
          <td class="w48 align-center"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['storage_array'][$v['goods_commonid']]['goods_id']));?>" target="_blank"><?php echo $lang['nc_view'];?></a></td>
        </tr>
