...
<div class="page">
   <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['dis_level_add'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="post" enctype="multipart/form-data" name="form1" id="link_form" >
  	...
  	<input type="hidden" name="op" value="addlevel">
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input id="level_name" name="level_name" class="txt" type="text"  /><font style="color:red"><?php echo $lang['time_unit']?></font></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input id="distribute_num" name="distribute_num" class="txt" type="text"  /></td>
          <td class="vatop tips"><span class="vatop rowform"></span></td>
        </tr>
         <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input id="distribute_rate" name="distribute_rate" class="txt" type="text"  /><B>%</B></td>
          <td class="vatop tips"><span class="vatop rowform"></span></td>
        </tr>
         <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input id="deposit" name="deposit" class="txt" type="text"  /></td>
          <td class="vatop tips"><span class="vatop rowform"></span></td>
        </tr>
         <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform">
          	<?php echo $lang['dis_has_member_num']?>:<input id="level_up_member" name="level_up_member" class="txt-short" style="width:80px;" type="text"  />&nbsp;或&nbsp;
            <?php echo $lang['dis_fx_cash']?>:<input id="level_up_consume" name="level_up_consume" class="txt-short" style="width:80px;" type="text"  />
          </td>
          <td class="vatop tips"><span class="vatop rowform"></span></td>
        </tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input id="grade" name="grade" class="txt" type="text" /></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="memo" id="memo"></textarea></td>
          <td class="vatop tips"><span class="vatop rowform"></span></td>
        </tr>
      </tbody>
