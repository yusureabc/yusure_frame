...
<div class="page">
  ...
  <form id="link_form" enctype="multipart/form-data" method="post">
    ...
    <input type="hidden" name="link_id" value="<?php echo $output['cl_array']['cl_id'];?>" />
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['cl_array']['cl_title'];?>" name="link_title" id="link_title" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MOBILE.'/cl/'.$output['cl_array']['cl_pic'];?>"></div>
            </span> <span class="type-file-box">
            <input name="link_pic" type="file" class="type-file-file" id="link_pic" size="30">
            </span></td>
          <td class="vatop tips"><?php if($output['cl_array']['cl_pic'] != ''){ ?>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
            <select name="link_methods" id="cl_methods">
            ...
            <input type="hidden" id="hi_methods" value="<?php echo $output['cl_array']['cl_methods'] ?>" />
          </td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['cl_array']['cl_openname'];?>" name="link_openname" id="link_openname" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['cl_array']['cl_sort'];?>" name="link_sort" id="link_sort" class="txt"></td>
...
$(document).ready( function() {
  ...
  $("#cl_methods").find("option[value=" + hi_methods  + "]").attr("selected", "selected");  // 赋给选中属性
});
</script> 
