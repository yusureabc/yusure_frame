...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['channel_config_index'];?></h3>
      <ul class="tab-base">
        <li><a href="index.php?act=channel_config&op=web_config&channel_id=<?php echo $output['channel_id'];?>"><span><?php echo '板块区';?></span></a></li>
        <li><a href="index.php?act=channel_config&op=web_edit&web_id=<?php echo $_GET['web_id'];?>&channel_id=<?php echo $output['channel_id'];?>"><span><?php echo $lang['channel_config_web_edit'];?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['channel_config_code_edit'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <table class="tb-type1 noborder">
    <tbody>
      <tr>
        <th><label><?php echo $lang['channel_config_web_name'];?>:</label></th>
        <td><label><?php echo $output['web_array']['web_name']?></label></td>
        <th><label><?php echo $lang['channel_config_style_name'];?>:</label></th>
  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td>
        <ul>
            <li><?php echo $lang['channel_config_edit_help1'];?></li>
            <li><?php echo $lang['channel_config_edit_help2'];?></li>
            <li><?php echo $lang['channel_config_edit_help3'];?></li>
          </ul></td>
      </tr>
    </tbody>
  </table>
  <table class="table tb-type2 nohover">
    <tbody>
      <tr>
        <td colspan="2" class="required"><label><?php echo $lang['channel_config_edit_html'].$lang['nc_colon'];?></label></td>
      </tr>
      <tr class="noborder">
        <td colspan="2" class="vatop"><div class="home-templates-board-layout style-<?php echo $output['web_array']['style_name'];?>">
            <div class="left">
              <dl id="left_tit">
                <dt>
                  <h4><?php echo $lang['channel_config_picture_tit'];?></h4>
              ...
              <dl>
                <dt>
                  <h4><?php echo $lang['channel_config_picture_act'];?></h4>
              ...
              <dl>
                <dt>
                  <h4><?php echo $lang['channel_config_edit_category'];?></h4>
                ...
                <dd class="category-list">
                  ...
                  <?php }else { ?>
                  <ul>
                    <li><a href="javascript:void(0);"><?php echo $lang['channel_config_gc_name'];?></a></li>
                    <li><a href="javascript:void(0);"><?php echo $lang['channel_config_gc_name'];?></a></li>
                    <li><a href="javascript:void(0);"><?php echo $lang['channel_config_gc_name'];?></a></li>
                    <li><a href="javascript:void(0);"><?php echo $lang['channel_config_gc_name'];?></a></li>
                    <li><a href="javascript:void(0);"><?php echo $lang['channel_config_gc_name'];?></a></li>
            ...
            <div class="middle">
              ...
              <?php } ?>
              <?php } ?>
              <div class="add-tab" id="btn_add_list"><a href="JavaScript:add_recommend();"><i class="icon-plus-sign-alt"></i><?php echo $lang['channel_config_add_recommend'];?></a><?php echo $lang['channel_config_recommend_max'];?></div>
              </div>
            </div>
            <div class="right">
              <dl>
                <dt>
                  <h4><?php echo $lang['channel_config_brand_title'];?></h4>
    ...
    <tfoot>
        <tr class="tfoot">
          <td colspan="2" ><a href="index.php?act=channel_config&op=web_html&web_id=<?php echo $_GET['web_id'];?>&channel_id=<?php echo $output['channel_id'];?>" class="btn" id="submitBtn"><span><?php echo $lang['channel_config_web_html'];?></span></a></td>
        </tr>
      </tfoot>
  </table>
</div>
...
<div id="upload_tit_dialog" style="display:none;">
  <table class="table tb-type2">
    <tbody>
      ...
      <tr>
        <td><ul>
            <li><?php echo $lang['channel_config_prompt_tit'];?></li>
          </ul></td>
      </tr>
    </tbody>
  </table>
  <form id="upload_tit_form" name="upload_tit_form" enctype="multipart/form-data" method="post" action="index.php?act=channel_api&op=upload_pic" target="upload_pic">
    ...
    <input type="hidden" name="channel_id" value="<?php echo $output['channel_id'];?>">
    <input type="hidden" name="tit[pic]" value="<?php echo $output['code_tit']['code_info']['pic'];?>">
    <input type="hidden" name="tit[url]" value="">
	  <table class="table tb-type2">
	    <tbody>
	      <tr>
	        <td colspan="2" class="required"><?php echo $lang['channel_config_upload_type'].$lang['nc_colon'];?>
	          </td>
	      </tr>
	      <tr class="noborder">
	        <td class="vatop rowform">
	        	<label title="<?php echo $lang['channel_config_upload_pic'];?>">
	        	...
	        	<span><?php echo $lang['channel_config_upload_pic'];?></span></label>
    ...
    <table id="upload_tit_type_pic" class="table tb-type2" <?php if($output['code_tit']['code_info']['type'] == 'txt'){ ?>style="display:none;"<?php } ?>>
      <tbody>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['channel_config_upload_tit'].$lang['nc_colon'];?></td>
        </tr>
        <tr class="noborder">
          ...
          <td class="vatop tips"><?php echo $lang['channel_config_upload_tit_tips'];?></td>
        </tr>
      </tbody>
    </table>
...
<div id="category_list_dialog" style="display:none;">
  <div class="dialog-handle">
    <h4 class="dialog-handle-title"><?php echo $lang['channel_config_category_title'];?></h4>
    <p><span class="handle">
      ...
      </span> <span class="note"><?php echo $lang['channel_config_category_note'];?></span></p>
  </div>
  <form id="category_list_form">
    ...
    <input type="hidden" name="channel_id" value="<?php echo $output['channel_id'];?>">
      <div class="s-tips"><i></i><?php echo $lang['channel_config_category_tips'];?></div>
    ...
    <a href="JavaScript:void(0);" onclick="update_category();" class="btn ml30"><span><?php echo $lang['channel_config_save'];?></span></a>
  </form>
</div>
<!-- 活动图片 -->
<div id="upload_act_dialog" class="upload_act_dialog" style="display:none;">
  <table class="table tb-type2">
    <tbody>
      ...
      <tr>
        <td><ul>
            <li><?php echo $lang['channel_config_prompt_act'];?></li>
          </ul></td>
      </tr>
    </tbody>
  </table>
  <form id="upload_act_form" name="upload_act_form" enctype="multipart/form-data" method="post" action="index.php?act=channel_api&op=upload_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    ...
    <table class="table tb-type2" id="upload_act_type_pic" <?php if($output['code_act']['code_info']['type'] == 'adv') { ?>style="display:none;"<?php } ?>>
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label><?php echo $lang['channel_config_upload_url'].$lang['nc_colon'];?></label></td>
        </tr>
        <tr class="noborder">
          ...
          <td class="vatop tips"><?php echo $lang['channel_config_upload_act_url'];?></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label><?php echo $lang['channel_config_upload_act'].$lang['nc_colon'];?></label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-box">
            <input type='text' name='textfield' id='textfield1' class='type-file-text' />
          ...
          <td class="vatop tips"><?php echo $lang['channel_config_upload_act_tips'];?></td>
        </tr>
      </tbody>
    </table>
  ...
  <form id="recommend_list_form">
    ...
    <?php foreach ($output['code_recommend_list']['code_info'] as $key => $val) { ?>
            <dl select_recommend_id="<?php echo $key;?>">
              <dt>
                <h4 class="dialog-handle-title"><?php echo $lang['channel_config_recommend_title'];?></h4>
                <div class="dialog-handle-box"><span class="left">
                  ...
                  </span><span class="right"><?php echo $lang['channel_config_recommend_tips'];?></span>
                  <div class="clear"></div>
                </div>
              </dt>
              <dd>
                <h4 class="dialog-handle-title"><?php echo $lang['channel_config_recommend_goods'];?></h4>
                  <div class="s-tips"><i></i><?php echo $lang['channel_config_recommend_goods_tips'];?></div>
    ...
    <h4 class="dialog-handle-title"><?php echo $lang['channel_config_recommend_add_goods'];?></h4>
    <div class="dialog-show-box">
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          <th><label><?php echo $lang['channel_config_recommend_gcategory'];?></label></th>
        ...
        <tr>
          <th><label for="recommend_goods_name"><?php echo $lang['channel_config_recommend_goods_name'];?></label></th>
    ...
    <div class="clear"></div>
    <a href="JavaScript:void(0);" onclick="update_recommend();" class="btn"><span><?php echo $lang['channel_config_save'];?></span></a>
  </form>
</div>
<!-- 中部推荐图片 -->
<div id="recommend_pic_dialog" style="display:none;">
  <form id="recommend_pic_form" name="recommend_pic_form" enctype="multipart/form-data" method="post" action="index.php?act=channel_api&op=recommend_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="web_id" value="<?php echo $output['code_recommend_list']['web_id'];?>">
    <input type="hidden" name="code_id" value="<?php echo $output['code_recommend_list']['code_id'];?>">
    <input type="hidden" name="channel_id" value="<?php echo $output['channel_id'];?>">
            ...
            <?php } ?>
              ...
              <td>
            	 <table class="table tb-type2">
                  ...
                  <tfoot>
                    <tr class="tfoot">
                      <td colspan="15" ><a href="JavaScript:void(0);" onclick="$('#recommend_pic_form').submit();" class="btn"><span><?php echo $lang['channel_config_save'];?></span></a></td>
                    </tr>
                  </tfoot>
                </table>
              </td>
  ...
  <form id="brand_list_form">
    ...
    <dd>
      <h4 class="dialog-handle-title"><?php echo '已选择品牌';?></h4>
          <div class="s-tips"><i></i><?php echo $lang['channel_config_brand_tips'];?></div>
    ...
    <h4 class="dialog-handle-title"><?php echo $lang['channel_config_brand_list'];?></h4>
    <div class="dialog-show-box">
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
    ...
    <a href="JavaScript:void(0);" onclick="update_brand();" class="btn"><span><?php echo $lang['channel_config_save'];?></span></a>
  </form>
</div>
<!-- 切换广告图片 -->
<div id="upload_adv_dialog" class="upload_adv_dialog" style="display:none;">
  <form id="upload_adv_form" name="upload_adv_form" enctype="multipart/form-data" method="post" action="index.php?act=channel_api&op=slide_adv" target="upload_pic">
    ...
    <table id="upload_slide_adv" class="table tb-type2" style="display:none;">
      <tbody>
        ...
        <tr>
          ...
          <td class="vatop tips"><?php echo $lang['channel_config_adv_url_tips'];?></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['channel_config_upload_adv_pic'].$lang['nc_colon'];?></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-box">
            <input type='text' name='textfield' id='textfield1' class='type-file-text' />
          ...
          <td class="vatop tips"><?php echo $lang['channel_config_upload_pic_tips'];?></td>
        </tr>
      </tbody>
    </table>
    <a href="JavaScript:void(0);" onclick="$('#upload_adv_form').submit();" class="btn"><span><?php echo $lang['channel_config_save'];?></span></a>
  </form>
</div>
...
<script src="<?php echo RESOURCE_SITE_URL;?>/channel_config/web_index.js"></script>