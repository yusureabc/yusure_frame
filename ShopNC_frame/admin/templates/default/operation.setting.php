          ...
          <td class="vatop tips"><?php echo $lang['voucher_allow_notice'];?></td>
            ...
            <table class="table tb-type2 nomargin">
     		...
     		<table>
              ...
              <thead>
                <tr class="thead">
                  <th colspan="2"><?php echo $lang['points_number_money']; ?></th>
                </tr>
              </thead>
              <tbody>
                <tr class="hover">
                  <td class="w200"><?php echo $lang['points_number_money_min'];?></td>
                  <td><input id="points_orderrate" name="points_number_money" value="<?php echo $output['list_setting']['points_number_money'];?>" class="txt" type="text" style="width:60px;">
                    <?php echo $lang['points_number_money_min_info']; ?></td>
                </tr>
                <tr class="hover">
                  <td><?php echo $lang['points_number_money_total']; ?></td>
                  <td><input id="points_ordermax" name="points_money" value="<?php echo $output['list_setting']['points_money'];?>" class="txt" type="text" style="width:60px;">
                    <?php echo $lang['points_number_money_total_info'];?></td>
                </tr>
     		 </tbody>
     		<table>
