  ...
  <form id="goods_class_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
            <td class="vatop rowform onoff"><label for="is_virtul1" class="cb-enable"><span>是</span></label>
                <label for="is_virtul0" class="cb-disable selected"><span>否</span></label>
                <input id="is_virtul1" name="is_virtul" value="1" type="radio">
                <input id="is_virtul0" name="is_virtul" value="0" type="radio"></td>
      ...
      <!-- 海外购 -->
        ...
        <tr class="noborder" id="is_overseas">
            <td class="vatop rowform onoff"><label for="is_oversea1" class="cb-enable"><span>是</span></label>
                <label for="is_oversea0" class="cb-disable selected"><span>否</span></label>
                <input id="is_oversea2" name="is_oversea" value="" type="hidden">
                <input id="is_oversea1" name="is_oversea" value="1" type="radio">
                <input id="is_oversea0" name="is_oversea" value="0" type="radio"></td>
...
<!-- <script>
  $(function(){
    $("#gc_parent_id").click(function(){
      var $gc_parent = $('#gc_parent_id').val();
      if ( $gc_parent == 0  ) {
        $('#oversea').show();
        $('#is_overseas').show();
      }
    ...
    $(function(){      
      $("#gc_parent_id").click(function(){
        ...
        if ($gc_parent == 0) {
          ...
          var url = 'index.php?act=goods_class&op=ajax&branch=check_oversea';
          $.ajax({
              url: url,
              type: 'get',
              data: {
              ...
              success: function( msg )
              {
                  if ( msg == 0 )
                  {
                    ...
                    $('#oversea').show();
                    $('#is_overseas').show();
                    document.getElementById("is_oversea2").value = "0";
                  }
                  else if( msg == 1 )
                  {
                    $('#oversea').hide();
                    $('#is_overseas').hide();
                   document.getElementById("is_oversea2").value = "1";
                  }
              },
              error: function( msg )
              {
