    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="noborder">
          ...
          <!--  固定运费 -->
            <input type="radio" name="freight" id="freight_1" value="0" onclick="span_freight();"/>
            <label for="freight_1"><?php echo $lang['admin_pointprod_fixed_freight']; ?></label>
            
          <!-- 使用运费模板 -->
            <input type="radio" name="freight" id="freight_0" value="1" onclick="freight_template();"/>
            <label for="freight_0"><?php echo $lang['admin_pointprod_freight_template']; ?></label>
            <input id="transport_id" type="hidden"  name="transport_id">
            <input id="transport_title" type="hidden"  name="transport_title">
          </td>
        ...
        <tr>
          ...
          <!-- g_freight -->
          　<input id="g_freight" class="txt-short" style="width: 40px;" name="g_freight" value="<?php printf('%.2f', floatval($output['goods']['goods_freight']));?>" />　元　
          </span>
          
          <span style="display: inline-block;" class="transport-name" id="postageName"></span>
          <span id="freight_template" style='display: none'>
