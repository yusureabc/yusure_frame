...
<div class="page">
  <table class="table tb-type2 order">
    <tbody>
      ...
      <tr>
        <td colspan="2"><ul>
            ...
            <li><strong><?php echo $lang['order_state'];?>:</strong><?php echo seaOrderState($output['order_info']);?></li>
      ...
      <tr>
        <td><ul>
            ...
            <li><strong><?php echo $lang['payment'];?><?php echo $lang['nc_colon'];?></strong><?php echo seaorderPaymentName($output['order_info']['payment_code']);?></li>
      ...
      <tr>
        <td><ul>
            ...
            <li><strong><?php echo $lang['id_card'];?><?php echo $lang['nc_colon'];?></strong><?php echo @$output['order_info']['extend_order_common']['reciver_info']['idcard'];?></li>
            ...
            <li><strong><?php echo $lang['logistics_company'];?><?php echo $lang['nc_colon'];?></strong><?php echo $output['order_info']['shipping_name'];?></li>
      ...
      <tr>
        <td><table class="table tb-type2 goods ">
            <tbody>
              ...
              <tr>
                <td class="w60 picture"><div class="size-56x56"><span class="thumb size-56x56"><i></i><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank"><img alt="<?php echo $lang['product_pic'];?>" src="<?php echo sea_thumb($goods, 60);?>" /> </a></span></div></td>
    ...
    <?php } ?>
    <?php } ?>
    <?php if(is_array($output['sea_order_log']) and !empty($output['sea_order_log'])) { ?>
      <tr>
      	<th><?php echo $lang['order_handle_history'];?></th><!-- 操作历史 -->
      </tr>
      <?php foreach($output['sea_order_log'] as $val) { ?>
      <tr>
        <td>
