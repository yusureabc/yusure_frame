    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <a class="btn-add-nofloat marginleft" href="index.php?act=sea_goods_class&op=goods_class_add&gc_parent_id=<?php echo $v['gc_id'];?>"><span><?php echo $lang['nc_add_sub_class'];?></span></a>
          </td>
          <td> </td>
          <td class="w84"><a href="index.php?act=sea_goods_class&op=goods_class_edit&gc_id=<?php echo $v['gc_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="javascript:if(confirm('<?php echo $lang['goods_class_index_ensure_del'];?>'))window.location = 'index.php?act=sea_goods_class&op=goods_class_del&gc_id=<?php echo $v['gc_id'];?>';"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
...
<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.sea_goods_class.js" charset="utf-8"></script> 
