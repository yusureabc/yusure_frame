...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=channel_api&op=focus_edit&channel_id=<?php echo $output['channel_id'];?>"><span><?php echo '焦点区';?></span></a></li>
  ...
  <form id="sale_list_form" method="post" name="form1">
    ...
    <div class="sale-layout">
      ...
      <?php } ?>
      <?php } ?>
      <div class="add-sale" id="add_list"><a class="btn-add-nofloat" href="JavaScript:add_sale_list();"><?php echo $lang['channel_config_add_recommend'];?></a><?php echo $lang['channel_config_sale_max'];?></div>
    </div>
    <a href="index.php?act=channel_api&op=html_update&web_id=<?php echo $output['code_sale_list']['web_id'];?>&channel_id=<?php echo $output['channel_id'];?>" class="btn"><span><?php echo $lang['channel_config_web_html'];?></span></a>
  </form>
</div>
...
<div id="sale_list_dialog" style="display:none;">
  ...
  <dl select_sale_id="<?php echo $key;?>">
    ...
    <dd>
      <div class="s-tips"><i></i><?php echo $lang['channel_config_goods_list_tips'];?></div>
  ...
  <div class="dialog-show-box">
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          <th><label><?php echo $lang['channel_config_goods_order_gcategory'];?></label></th>
        ...
        <tr>
          <th><label><?php echo $lang['channel_config_goods_order_type'];?></label></th>
          <td><select name="goods_order" id="goods_order">
              <option value="goods_salenum" selected><?php echo $lang['channel_config_goods_order_sale'];?></option>
              <option value="goods_click" ><?php echo $lang['channel_config_goods_order_click'];?></option>
              <option value="evaluation_count" ><?php echo $lang['channel_config_goods_order_comment'];?></option>
              <option value="goods_collect" ><?php echo $lang['channel_config_goods_order_collect'];?></option>
            </select></td>
          <th><label for="order_goods_name"><?php echo $lang['channel_config_goods_order_name'];?></label></th>
  ...
  <div class="clear"></div>
  <a href="JavaScript:void(0);" onclick="update_sale();" class="btn"><span><?php echo $lang['channel_config_save'];?></span></a> </div>
