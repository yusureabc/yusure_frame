  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="javascript:void(0);"  class="current"><span><?php echo $lang['fxad_edit'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form id="adv_form" enctype="multipart/form-data" method="post" name="advForm">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="fx_name" id="fx_name" class="txt" value="<?php echo $output['info']['title']?>"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="fx_goodsid" id="fx_goodsid" class="txt" value="<?php echo $output['info']['goods_id']?>"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="fx_price" id="fx_price" class="txt" value="<?php echo $output['info']['price']?>"></td>
          <td class="vatop tips"></td>
        </tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="fx_url" id="fx_url" class="txt" value="<?php echo $output['info']['linkurl']; ?>"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input class="txt" name="fx_color" type="color" value="<?php echo $output['info']['backcolor']?>" /></td>
