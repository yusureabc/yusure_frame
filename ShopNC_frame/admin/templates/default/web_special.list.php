...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?act=web_special&op=web_special_drop');
        $('#special_id').val(id);
        $('#list_form').submit();
    }
}
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w84 align-center">
              ...
              <a href="<?php echo SHOP_SITE_URL;?>/index.php?act=special&op=special_detail&special_id=<?php echo $val['special_id'];?>" target="_blank"><?php echo $lang['cms_text_see'];?></a>
              <?php } else { ?>
              <a href="index.php?act=web_special&op=web_special_detail&special_id=<?php echo $val['special_id'];?>" target="_blank"><?php echo $lang['cms_text_view'];?></a>
              <?php } ?>
              <a href="index.php?act=web_special&op=web_special_edit&special_id=<?php echo $val['special_id'];?>"><?php echo $lang['nc_edit'];?></a>
