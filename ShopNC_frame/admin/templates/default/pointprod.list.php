    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w48 picture"><div class="size-44x44"><span class="thumb size-44x44"><i></i><img height="44" width="44" src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_POINTPROD.DS.str_ireplace('.', '_small.', $v['pgoods_image']); ?>" onload="javascript:DrawImage(this,44,44);"/></span></div></td>
