  ...
  <form id="class_add_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" name="cate_title" id="cate_title" class="txt"></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          ...
          <input id="class_linkurl" name="class_linkurl" type="text" class="txt">
          </td>
           <tr>
        ...
        <tr class="noborder">
          ...
          <span class="type-file-box">
            <input type="file" name="class_pic" id="class_pic" class="type-file-file" size="30" >
          </span>  
            </td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="255" name="class_sort" id="class_sort" class="txt"></td>
