    ...
    <div style="width: 49%; float: left; margin: 10px 0; border: solid #DEEFFB; border-width: 0 0 1px 0;">
      <table class="table tb-type2">
        <thead class="thead">
          ...
          <tr>
            <th style="text-align: right;" colspan="15"><a class="btns" nctype="spec_hide" href="javascript:viod(0);"><span><?php echo $lang['type_common_checked_hide'];?></span></a></th>
          </tr>
        </thead>
      </table>
    ...
    <div style="width: 49%; float: right; margin: 10px 0; border: solid #DEEFFB; border-width: 0 0 1px 0;">
      <table class="table tb-type2">
        <thead class="thead">
          ...
          <tr>
            <th style="text-align: right;" colspan="15"><a class="btns" nctype="brand_hide" href="javascript:viod(0);"><span><?php echo $lang['type_common_checked_hide'];?></span></a></th>
          </tr>
        </thead>
      </table>
    ...
    <table class="table tb-type2">
      ...
      <tbody id="tr_model">
        ...
        <tr class="hover edit">
		  ...
		  <td class="align-center power-onoff"><input type="checkbox" class="change_default_submit_value" <?php if($aval['is_check'] == '1'){echo 'checked="checked"';}?> nc_type="checked_show" />
            <input type="hidden" name="at_value[<?php echo $aval['attr_id'];?>][is_check]" value="<?php echo $aval['is_check'];?>" /></td>
...
$(function(){
	...
	var tr_model = '<tr class="hover edit"><td></td>'+
		...
		'<td class="align-center power-onoff"><input type="checkbox" checked="checked" nc_type="checked_show" /><input type="hidden" name="at_value[key][is_check]" value="1" /></td>'+
