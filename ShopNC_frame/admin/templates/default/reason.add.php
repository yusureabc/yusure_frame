  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="javascript:void(0);" class="current"><span><?php echo $lang['nc_admin_add_reason'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <input type="hidden" name="op" value="service_add" />
    <table class="table tb-type2">
      ...
      <!-- 原因内容 -->
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text"  name="reason_content" id="reason_content" class="txt"></td>
          <td class="vatop tips"><?php echo $lang['class_name_error'];?></td>
        </tr>
      </tbody>
      <tfoot>
