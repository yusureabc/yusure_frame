...
<?php }?>
<form method="post" id="goods_image" action="<?php if ($output['edit_goods_sign']) { echo urlAdmin('sea_goods_online', 'edit_save_image'); } else { echo urlAdmin('sea_goods_add', 'save_image');}?>">
      ...
      <div class="ncsc-goodspic-list">
        ...
        <ul nctype="ul<?php echo $value['sp_value_id'];?>">
          ...
          <li class="ncsc-goodspic-upload">
            <div class="upload-thumb"><img src="<?php echo sea_cthumb($output['img'][$value['sp_value_id']][$i]['goods_image'], 240);?>" nctype="file_<?php echo $value['sp_value_id'] . $i;?>">
        ...
        <div class="ncsc-select-album">
          <a class="ncsc-btn" href="index.php?act=sea_album&op=pic_list&item=goods_image&color_id=<?php echo $value['sp_value_id'];?>" nctype="select-<?php echo $value['sp_value_id'];?>"><i class="icon-picture"></i>从图片空间选择</a>
...
<script src="<?php echo RESOURCE_SITE_URL;?>/js/sea_goods/store_goods_add.step3.js" charset="utf-8"></script>
<script>
