  ...
  <form id="grade_form" method="post">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['grade_array']['sg_album_limit'];?>" id="sg_album_limit" name="sg_album_limit" class="txt"></td><td class="vatop tips"></td>
		</tr>
        <tr>
