...
<div class="page">
  ...
  <form id="channel_column_form" method="post">
    ...
    <input type="hidden" name="channel_id" value="<?php echo $output['channel_column_array']['channel_id'];?>" />
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['channel_column_array']['channel_name'];?>" name="channel_name" id="channel_name" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['channel_column_array']['channel_url'];?>" name="channel_url" id="channel_url" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
    	<tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="channel_remark" id=""><?php echo $output['channel_column_array']['channel_remark'];?></textarea></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['channel_column_array']['channel_sort'];?>" name="channel_sort" id="channel_sort" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
      </tbody>
      <tfoot>
