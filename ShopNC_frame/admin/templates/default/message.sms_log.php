    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th><?php echo $lang['sms_receive_tel'];?></th>
          
          <th class="align-center"><?php echo $lang['sms_behavior'];?></th>
          <th class="align-center"><?php echo $lang['sms_time'];?></th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr class="hover">
          ...
          <td><?php echo $v['tomember_name']; ?></td>
          <td><?php echo $v['title'];?></td>
          <td class="align-center"><?php echo date('Y-m-d H:i:s',$v['dateline']); ?></td>
