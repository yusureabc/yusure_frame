  ...
  <form id="link_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="link_title" id="link_title" value="<?php echo $output['the_ad']['link_title'];?>" class="txt"></td>
            ...
            <select name="link_area" id="link_area">
             <option value="">---请选择---</option>
              <?php foreach($output['area_list'] as $k=>$v) {?>
                <option value="<?php echo $v['area_id'];?>" <?php if($output['the_ad']['link_city']==$v['area_id']){echo 'selected="selected"';}?>><?php echo $v['area_name'];?></option>
                <?php } ?>
            </select>
          </td>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
            <input type="text" name="link_link" id="link_link" value="<?php echo $output['the_ad']['link_link'];?>"class="txt" >
          </td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="link_sort" id="link_sort" value="<?php echo $output['the_ad']['link_sort'];?>" class="txt"></td>
    ...
    <input type="hidden" name="link_id" value="<?php echo $output['the_ad']['link_id'];?>">
  </form>
</div>
<script>
//按钮先执行验证再提交表单
