  ...
  <form id="ship_form" method="post" name="ship_form" action="index.php?act=pointorder&op=order_ship&id=<?php echo $_GET['id']; ?>">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <!-- 物流公司 -->
        <tr>
          <td colspan="2" class="required"><label> <?php echo '物流公司'; ?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" id="shippingname" name="shippingname" class="txt" value="<?php echo $output['order_info']['point_shippingname']; ?>"></td>
          <td class="vatop tips"></td>
        </tr>
        <!-- 物流单号 -->
        <tr>
