...
<div class="page">
  ...
  <div class="fixed-empty"></div>
    <form action="index.php?act=store&op=store_joinin_detail_edit" method="post" id="edit_form">
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      <tr>
        ...
        <td colspan="20">
    	<?php echo $output['joinin_detail']['company_name'];?>
      ...
      <tr>
        <th>公司所在地：</th>
        <td colspan="10">
    		<input id="company_address" class="company_address" name="company_address" type="hidden" value="<?php echo $output['joinin_detail']['company_address'];?>" /><span></span>	
    	</td>
        </tr>
        <tr>
        <th>公司详细地址：</th>
        <td colspan="20"><input type="text" name="company_address_detail" id="company_address_detail" value="<?php echo $output['joinin_detail']['company_address_detail'];?>" class="w200"><span></span></td>
      </tr>
      <tr>
        <th>公司电话：</th>
        <td><input type="text" name="company_phone" value="<?php echo $output['joinin_detail']['company_phone'];?>"><span></span></td>
        <th>员工总数：</th>
        <td><input type="text" name="company_employee_count" value="<?php echo $output['joinin_detail']['company_employee_count'];?>" size="8">&nbsp;人<span></span></td>
        <th>注册资金：</th>
        <td><input type="text" name="company_registered_capital" value="<?php echo $output['joinin_detail']['company_registered_capital'];?>" size="10">&nbsp;万元 <span></span></td>
      </tr>
      <tr>
        <th>联系人姓名：</th>
        <td><input type="text" name="contacts_name" value="<?php echo $output['joinin_detail']['contacts_name'];?>"><span></span></td>
        <th>联系人电话：</th>
        <td><input type="text" name="contacts_phone" value="<?php echo $output['joinin_detail']['contacts_phone'];?>"><span></span></td>
        <th>电子邮箱：</th>
        <td><input type="text" name="contacts_email" value="<?php echo $output['joinin_detail']['contacts_email'];?>"><span></span></td>
      </tr>
    </tbody>
  </table>
  <a href="JavaScript:void(0);" class="btn" id="submitBtn"><span>修改</span></a>
    </form>
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    <thead>
      <tr>
