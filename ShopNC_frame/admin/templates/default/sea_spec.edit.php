...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=sea_spec&op=spec"><span><?php echo $lang['nc_manage'];?></span></a></li>
...
<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/overseas_common_select.js" charset="utf-8"></script> 
