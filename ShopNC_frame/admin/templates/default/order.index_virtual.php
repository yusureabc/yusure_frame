...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="op" value="index_virtual" />
      ...
      <tr class="hover">
        ...
        <td class="align-center">
            <?php if($order['order_state']==20) {?>
                电子券已发放
             <?php }else{ ?>
            <?php echo orderState($order);?>
            <?php } ?>
        </td>
        <td class="w144 align-center"><a href="index.php?act=order&op=show_order_virtual&order_id=<?php echo $order['order_id'];?>"><?php echo $lang['nc_view'];?></a>
        ...
        <!-- 取消订单 -->
    		...
    		<?php if($order['if_system_receive_pay']) {?>
	        	| <a href="index.php?act=order&op=change_state&state_type=receive_pay&isv=1&order_id=<?php echo $order['order_id']; ?>">
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
    	$('input[name="op"]').val('index_virtual');$('#formSearch').submit();
    });
});
</script> 
