...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['nc_member_predepositpb'];?></h3>
      <ul class="tab-base">
      <li><a href="index.php?act=currency&op=addcurrency"><span><?php echo $lang['nc_manage']?></span></a></li>
      <li><a href="index.php?act=currency&op=currencylog"><span><?php echo $lang['currency_detailed'];?></span></a></li>
      <li><a href="JavaScript:void(0);"  class="current"><span><?php echo $lang['currency_deposit']?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="op" value="pb_cash_list">
      ...
      <tbody>
        ...
        <tr>
            ...
            <select id="paystate_search" name="paystate_search">
              ...
              <option value="3" <?php if($_GET['paystate_search'] == '3' ) { ?>selected="selected"<?php } ?>>已拒绝</option>
            </select>
  ...
  <table class="table tb-type2 nobdb">
    <thead>
      <tr class="thead">
        ...
        <th class="align-center"><?php echo $lang['currency_predeposit_pbnum']; ?></th>
    ...
    <tbody>
      ...
      <tr class="hover">
        <td class="w12">&nbsp;</td>
        <td><?php echo $v['pb_sn']; ?></td>
        <td><?php echo $v['pb_member_name']; ?></td>
        <td class="nowrap align-center"><?php echo @date('Y-m-d H:i:s',$v['pb_add_time']);?></td>
        <td class="align-center"><?php echo $v['pb_money'];?></td>
        <td class="align-center"><?php echo $v['pb_amount'];?></td>
        <td class="align-center"><?php echo str_replace(array('0','1','3'), array('未支付','已支付','已拒绝'), $v['pb_payment_state']); ?></td>
        <td class="w90 align-center">
          <?php if ($v['pb_payment_state'] == '0'){ ?>
          <a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del']; ?>')){window.location='index.php?act=currency&op=pb_cash_del&id=<?php echo $v['pb_id']; ?>';}else{return false;}"><?php echo $lang['nc_del']; ?></a> 
          <?php } ?><a href="index.php?act=currency&op=pb_cash_view&id=<?php echo $v['pb_id']; ?>" class="edit"><?php echo $lang['nc_view']; ?></a>
          </td>
      </tr>
      <?php } ?>
      <?php }else { ?>
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
    	$('input[name="op"]').val('pb_cash_list');$('#formSearch').submit();
    });
});
</script>