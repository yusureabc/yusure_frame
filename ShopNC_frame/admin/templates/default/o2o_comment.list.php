  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=comment&op=evaluation_list" ><span><?php echo $lang['nc_distribution_evaluation'];?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td><a  href="javascript:void(0)" target="_blank"><?php echo $val['store_name'];?></a></td>
		  <td><?php echo $val['member_name'];?></td>
		  <td><?php echo $val['comment'];?></td>
		   <td><?php echo $val['amount_score'];?>分</td>
