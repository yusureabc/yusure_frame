...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=o2o_area&op=area_edit">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="area_name" id="area_name" onchange="query();" onmouseout="query();" class="txt" value="<?php echo $output['area_info']['area_name'];?>"></td>
...
<!-- 百度地图 -->
    ...
    <tr class="noborder">
      <td class="vatop rowform"><input type="text" value="<?php echo $output['area_info']['longitude'];?>" name="txtPoint" id="txtPoint" class="txt" readonly="readonly" ></td>
      <td class="vatop tips"><?php echo $lang['offline_area_name_error'];?></td>
    </tr>
    
    <!-- 完整首字母 -->
    <tr class="noborder">
          <td colspan="2" class="required"><label class="validation" for="area_first_letter"><?php echo $lang['nc_admin_fullfirst_letter'].$lang['nc_colon'];?></label></td>
        </tr>
    <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['area_info']['full_first_letter'];?>" name="full_first_letter" id="full_first_letter" class="txt"></td>
          <td id="szm" >
     ...
     <!-- 上级区域 -->
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff">
          	<label for="state1" class="cb-enable <?php if($output['area_info']['is_state'] == '1'){ echo 'selected';}?>"  ><span><?php echo $lang['open'];?></span></label>
            <label for="state0" class="cb-disable <?php if($output['area_info']['is_state'] == '0'){ echo 'selected';}?>" ><span><?php echo $lang['close'];?></span></label>
