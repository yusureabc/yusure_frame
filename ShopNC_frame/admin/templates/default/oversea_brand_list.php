...
<div class="page">
  ...
  <form method="get" name="brand_search" id="brand_search">
    <input type="hidden" name="act" value="overseas_brand">
      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:void(0);" id="ncsubmit" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a class="btns " href="index.php?act=overseas_brand&op=brand_list" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?>---搜索</span></a>
            <?php }?>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="picture"><div class="brand-picture"><img src="<?php echo $v['brand_pic'];?>"/></div></td>
          ...
          <td class="align-center">
          	<a href="index.php?act=overseas_brand&op=brand_edit&brand_id=<?php echo $v['brand_id'];?>"><?php echo $lang['nc_edit'];?></a>
          	&nbsp;|&nbsp;
          	<a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?act=overseas_brand&op=brand_del&del_brand_id=<?php echo $v['brand_id'];?>';}else{return false;}"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
      ...
      <tfoot>
        ...
        <tr colspan="15" class="tfoot">
          ...
          <td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
            &nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" onclick="alert(document.brandForm.action);return false;document.brandForm.submit()"><span><?php echo $lang['nc_del'];?></span></a>
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
    	$('input[name="op"]').val('brand_list');$('#brand_search').submit();
    });	
});
</script>