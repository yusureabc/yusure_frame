  ...
  <form id="post_form" method="post" name="form1">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_wxpay_partnerid'];?>: </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="hidden" name="config_name" value="wxpay_partnerid,wxpay_partnerkey,wxpay_appid,wxpay_paysignkey,wxpay_appsecret,wxpay_token" />
            <input name="wxpay_partnerid" id="wxpay_partnerid" value="<?php echo $output['config_array']['wxpay_partnerid'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_wxpay_partnerkey'];?>:
            </th></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="wxpay_partnerkey" id="wxpay_partnerkey" value="<?php echo $output['config_array']['wxpay_partnerkey'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_wxpay_paysignkey'];?>:
            </th></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="wxpay_paysignkey" id="wxpay_paysignkey" value="<?php echo $output['config_array']['wxpay_paysignkey'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_wxpay_appid'];?>:
            </th></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="wxpay_appid" id="wxpay_appid" value="<?php echo $output['config_array']['wxpay_appid'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_wxpay_appsecret'];?>:
            </th></td>
        </tr>
        
        <tr class="noborder">
          <td class="vatop rowform"><input name="wxpay_appsecret" id="wxpay_appsecret" value="<?php echo $output['config_array']['wxpay_appsecret'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_wxpay_token'];?>:
            </th></td>
        </tr>
        	
        <tr class="noborder">
          <td class="vatop rowform"><input name="wxpay_token" id="wxpay_token" value="<?php echo $output['config_array']['wxpay_token'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
    	<?php } elseif ($output['payment']['payment_code'] == 'allinpay') { ?>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_allinpay_account'];?>: </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="hidden" name="config_name" value="allinpay_account,allinpay_key" />
            <input name="allinpay_account" id="allinpay_account" value="<?php echo $output['config_array']['allinpay_account'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_allinpay_key'];?>:
            </th></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="allinpay_key" id="allinpay_key" value="<?php echo $output['config_array']['allinpay_key'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
