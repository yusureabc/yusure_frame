...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=merchant&op=storelist&state=2" ><span><?php echo $lang['nc_manage'];?></span></a></li>
  ...
  <form id="add_form" method="post" action="index.php?act=merchant&op=applycheck">
	...
	$("#add_form").validate({
        ...
        rules : {
        	account : {
                required : true,
				remote	: {
                    url :'index.php?act=merchant&op=checkaccount',
                    type:'get',
                    data:{
                    	admin_name : function(){
                            return $('#account').val();
