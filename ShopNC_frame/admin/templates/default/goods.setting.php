      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff">
          	<label for="rewrite_enabled"  class="cb-enable <?php if($output['list_setting']['goods_verify'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_yes'];?>"><span><?php echo $lang['nc_yes'];?></span></label>
        ...
        <tr class="noborder">
          <td colspan="2" class="required"><label><?php echo $lang['goods_sale_num_base']?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform onoff">
          	<label for="rewrite_enableds"  class="cb-enable <?php if($output['list_setting']['goods_base_salenum'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_yes'];?>"><span><?php echo $lang['nc_yes'];?></span></label>
            <label for="rewrite_disableds" class="cb-disable <?php if($output['list_setting']['goods_base_salenum'] != '1'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_no'];?>"><span><?php echo $lang['nc_no'];?></span></label>
            <input id="rewrite_enableds" name="goods_base" <?php if($output['list_setting']['goods_base_salenum'] == '1'){ ?>checked="checked"<?php } ?> value="1" type="radio">
            <input id="rewrite_disableds" name="goods_base" <?php if($output['list_setting']['goods_base_salenum'] != '1'){ ?>checked="checked"<?php } ?> value="0" type="radio"></td>
          <td class="vatop tips">
            <?php echo $lang['open_rewrite_tips'];?></td>
        </tr>
      </tbody>
