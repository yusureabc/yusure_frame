...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_admin_goods_operation'];?>')) {
        $('#list_form').attr('method','post');
       	$('#list_form').attr('action','index.php?act=o2o_goods&op=delgoods');
      ...
      <tbody>
        ...
        <tr class="hover edit">
		  ...
		  <td class='align-center'>
		  	<a href="javascript:if(confirm('<?php echo $lang['nc_admin_confirm_delete'];?>'))window.location = 'index.php?act=o2o_goods&op=delgoods&goods_id=<?php echo $val['goods_id'];?>';"><?php echo $lang['nc_del'];?></a>
		  </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
