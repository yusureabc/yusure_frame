...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=channel_api&op=sale_edit&channel_id=<?php echo $output['channel_id'];?>"><span><?php echo '促销区';?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <div class="homepage-focus" id="homepageFocusTab">
    ...
    <form id="upload_screen_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?act=channel_api&op=screen_pic" target="upload_pic">
      ...
      <div class="margintop"><a href="JavaScript:void(0);" onclick="$('#upload_screen_form').submit();" class="btn"><span><?php echo $lang['channel_config_save'];?></span></a> 
        <a href="index.php?act=channel_api&op=html_update&web_id=<?php echo $output['code_screen_list']['web_id'];?>&channel_id=<?php echo $output['channel_id'];?>" class="btn"><span><?php echo $lang['channel_config_web_html'];?></span></a></div>
    </form>
    <form id="upload_focus_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?act=channel_api&op=focus_pic" target="upload_pic" style="display:none;">
      <input type="hidden" name="form_submit" value="ok" />
      ...
      <a href="JavaScript:void(0);" onclick="$('#upload_focus_form').submit();" class="btn"><span><?php echo $lang['channel_config_save'];?></span></a> 
      <a href="index.php?act=channel_api&op=html_update&web_id=<?php echo $output['code_screen_list']['web_id'];?>&channel_id=<?php echo $output['channel_id'];?>" class="btn"><span><?php echo $lang['channel_config_web_html'];?></span></a>
    </form>
  </div>
</div>
...
<script src="<?php echo RESOURCE_SITE_URL;?>/channel_config/web_focus.js"></script>