...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=merchant&op=storelist"><span><?php echo $lang['nc_manage'];?></span></a></li>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
		  ...
		  <td class='align-center'><a href="javascript:if(confirm('您确定要开启该店铺吗？'))window.location.href='index.php?act=merchant&op=storestate&store_id=<?php echo $val['store_id'];?>&member_id=<?php echo $val['member_id'];?>&state=2';"><?php echo $lang['nc_admin_store_start'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
