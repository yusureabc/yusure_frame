        ...
        <table class="table tb-type2">
            ...
            <tbody>
                ...
                <tr class="hover edit">
                    ...
                    <td>
                        <a href="<?php echo urlShop('show_store','index', array('store_id' => $value['store_id']));?>" target="_blank">
                            <?php echo $value['store_name'];?>
                        </a>
                    </td>
                    <td><?php echo $value['member_name'];?></td>
                    <td class="w150"><?php echo $value['area_info'];?></td>
                    <td><?php echo empty($value['store_end_time'])?Language::get('no_limit'):date('Y-m-d H:i:s',$value['store_end_time']);?></td>
                    <td>
                        <?php if($store_exist) {?>
