  ...
  <div class="fixed-empty"></div>
    ...
    <table class="table tb-type2" id="main_table">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="goods_name" id="goods_name" class="txt" value="<?php echo $output['goods_info']['adv_content']['goods_name'];?>"></td>
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="goods_slogan_one" id="goods_slogan_one" class="txt" value="<?php echo $output['goods_info']['adv_content']['goods_slogan_one'];?>"></td>
          <td class="vatop tips"></td>
        </tr>
      </tbody>
        <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="goods_slogan_two" id="goods_slogan_two" class="txt" value="<?php echo $output['goods_info']['adv_content']['goods_slogan_two'];?>"></td>
          <td class="vatop tips"></td>
        </tr>
      </tbody>
       <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="goods_price" id="goods_price" class="txt" value="<?php echo $output['goods_info']['adv_content']['goods_price'];?>"></td>
          <td class="vatop tips"></td>
        </tr>
      </tbody>
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL.'/home/'.$output['goods_info']['adv_content']['goods_pic'];?>"></div>
            </span> <span class="type-file-box">
            <input name="goods_pic" type="file" class="type-file-file" id="goods_pic" size="30">
            </span>
          </td>
        </tr>
      </tbody>
      <tbody id="product_url">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="goods_url" class="txt" id="goods_url" value="<?php echo $output['goods_info']['adv_content']['goods_url'];?>"></td>
        </tr>
      </tbody>
      <tbody>
         <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="goods_introduce" id="goods_introduce" class="tarea"><?php echo $output['goods_info']['adv_content']['goods_introduce'];?></textarea></td>
          <td class="vatop tips"></td>
        </tr>
      </tbody>
      <tbody id="product_sort">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="goods_sort" class="txt" id="goods_sort" value="<?php echo $output['goods_info']['adv_content']['goods_sort'];?>"></td>
        </tr>
      </tbody>
      <tfoot>
        <tr class="tfoot">
