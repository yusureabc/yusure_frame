...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=sea_article&op=article"><span><?php echo $lang['nc_manage'];?></span></a></li>
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?act=sea_article&op=article_pic_upload&item_id=<?php echo $output['article_array']['article_id'];?>',
...
function del_file_upload(file_id)
{
    ...
    $.getJSON('index.php?act=sea_article&op=ajax&branch=del_file_upload&file_id=' + file_id, function(result){
        if(result){
            $('#' + file_id).remove();
        }else{
