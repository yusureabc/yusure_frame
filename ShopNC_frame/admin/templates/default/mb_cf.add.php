...
<div class="page">
  ...
  <form id="add_form" method="post" action="index.php?act=mb_cf&op=mb_cf_add_save">
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input id="class_sort" name="class_sort" type="text" class="txt" value="1" /></td>
