...
<div class="page">
  ...
  <form id="add_form" method="post" action="index.php?act=mb_cf&op=mb_cf_update">
    <table class="table tb-type2">
      <input type="hidden" name="class_id" value="<?php echo $output['updatelist']['cf_id']; ?>" />
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['updatelist']['cf_name']; ?>" name="class_name" id="class_name" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input id="class_sort" name="class_sort" type="text" class="txt" value="<?php echo $output['updatelist']['cf_sort']; ?>" /></td>
