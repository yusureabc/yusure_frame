...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
         ...
         <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['nc_admin_srevice_edit'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <input type="hidden" name="op" value="service_edit" />
  <input type="hidden" name="service_id" value="<?php echo $output['info']['id']; ?>" />
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['info']['name']; ?>" name="service_name" id="service_name" class="txt"></td>
