  ...
  <form id="list_form" method="post">
    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
            <td></td>
            <td class="align-left"><a href="<?php echo urlShop('show_store','index', array('store_id'=>$val['quota_storeid']));?>" target="_blank"><span><?php echo $val['quota_storename'];?></span></a></td>
