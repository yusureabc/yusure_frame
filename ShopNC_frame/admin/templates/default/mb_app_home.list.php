...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
    	...
    	<li><a href="index.php?act=mb_app_home&op=mb_app_home_add"><span><?php echo $lang['nc_add'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td><ul>
            <li><?php echo $lang['app_home_help1'];?></li>
          </ul></td>
      </tr>
    </tbody>
  </table>
    ...
    <table class="table tb-type2 nobdb">
      <thead>
        <tr class="thead">
          ...
          <th><?php echo $lang['app_home_index_title'];?></th>
          <th><?php echo $lang['app_home_index_desc'];?></th>
          <th><?php echo $lang['app_home_index_type'];?></th>
          <th><?php echo $lang['app_home_index_keyword'];?></th>
          <th><?php echo $lang['app_home_index_multi_keyword'];?></th>
          <th><?php echo $lang['app_home_index_pic_sign'];?></th>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="picture"><?php 
				...
				?></td>
          <td class="w96 align-center"><a href="index.php?act=mb_app_home&op=mb_app_home_edit&h_id=<?php echo $v['h_id'];?>"><?php echo $lang['nc_edit'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
