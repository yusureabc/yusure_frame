...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="<?php echo urlAdmin( 'sea_goods', 'goods');?>" ><span><?php echo $lang['goods_index_all_goods'];?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span> <?php echo $lang['goods_index_off_goods']; ?> </span></a></li>
      </ul>
    </div>
  </div>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="align-center">
            <p><a href="<?php echo urlShop('sea_goods', 'index', array('goods_id' => $output['storage_array'][$v['goods_commonid']]['goods_id']));?>" target="_blank"><?php echo $lang['nc_view'];?></a></p>
          </td>
        </tr>
