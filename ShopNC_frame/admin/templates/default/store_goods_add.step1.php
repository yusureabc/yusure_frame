...
<?php } else {?>
<ul class="add-goods-step center">
...
<div class="wrapper_search">
        ...
        <div class="wp_category_list">
          <div id="class_div_1" class="category_list">
            <ul>
              ...
              <li class="" nctype="selClass" data-param="{gcid:<?php echo $val['gc_id'];?>,deep:1}"> <a class="" href="javascript:void(0)"><i class="icon-double-angle-right"></i><?php echo $val['gc_name'];?></a></li>
              <?php }?>
              <?php }?>
            </ul>
          </div>
  ...
  <div class="alert">
    <dl class="hover_tips_cont">
      ...
      <dt id="commoditydt" style="display: none;" class="current_sort">您当前选择的商品类别是<?php echo $lang['nc_colon'];?></dt>
  ...
  <div class="wp_confirm">
    <form method="get">
      <?php if ($output['edit_goods_sign']) {?>
      <input type="hidden" name="act" value="sea_goods_online" />
      ...
      <?php } else {?>
      <input type="hidden" name="act" value="sea_goods_add" />
...
<script src="<?php echo RESOURCE_SITE_URL;?>/js/sea_goods/store_goods_add.step1.js"></script> 
<script>
