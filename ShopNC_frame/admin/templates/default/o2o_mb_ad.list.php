    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w96 align-center"><a href="index.php?act=o2o_mb_ad&op=mb_ad_edit&link_id=<?php echo $v['link_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>'))window.location = 'index.php?act=o2o_mb_ad&op=mb_ad_del&link_id=<?php echo $v['link_id'];?>';"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
