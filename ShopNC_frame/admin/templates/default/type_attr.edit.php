  ...
  <form id="attr_form" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
		...
		<tr>
          <td class="required" colspan="2"><label>是否多选</label></td>
        </tr>
        <tr class="noborder">
		  <td class="vatop rowform onoff"><label for="is_check1" class="cb-enable <?php if($output['attr_info']['is_check'] == '1'){?>selected<?php }?>"><span><?php echo $lang['nc_yes'];?></span></label>
            <label for="is_check0" class="cb-disable <?php if($output['attr_info']['is_check'] == '0'){?>selected<?php }?>"><span><?php echo $lang['nc_no'];?></span></label>
            <input id="is_check1" name="is_check" <?php if($output['attr_info']['is_check'] == '1'){?>checked="checked"<?php }?> value="1" type="radio" />
            <input id="is_check0" name="is_check" <?php if($output['attr_info']['is_check'] == '0'){?>checked="checked"<?php }?> value="0" type="radio" />
          </td>
          </tr>
      </tbody>
    </table>
