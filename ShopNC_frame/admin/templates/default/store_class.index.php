    ...
    <tbody>
      ...
      <tr>
        <td><ul>
            ...
            <li><?php echo $lang['store_class_help3'];?></li>
          </ul></td>
      </tr>
    </tbody>
  </table>
  <form method='post'>
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td class="w36"><input type="checkbox" name='check_sc_id[]' value="<?php echo $v['sc_id'];?>" class="checkitem">
            <?php if($v['have_child'] == '1'){ ?>
            <img fieldid="<?php echo $v['sc_id'];?>" status="open" nc_type="flex" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/tv-expandable.gif">
            <?php }else{ ?>
            <img fieldid="<?php echo $v['sc_id'];?>" status="close" nc_type="flex" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/tv-item.gif">
            <?php } ?></td>
          ...
          <td class="name">
          	...
          	<a class='btn-add-nofloat marginleft' href="index.php?act=store_class&op=store_class_add&sc_parent_id=<?php echo $v['sc_id'];?>"><?php echo $lang['add_lower'];?></a>
          </td>
      ...
      <tfoot>
        ...
        <tr id="batchAction" >
          ...
          <td colspan="16" id="dataFuncs"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
            &nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" onclick="if(confirm('<?php echo $lang['del_store_class'];?>')){$('form:first').submit();}"><span><?php echo $lang['nc_del'];?></span></a></td>
        </tr>
        <?php } ?>
      </tfoot>
    </table>
