...
<div class="goods-gallery" nctype="gallery-<?php echo $output['color_id'];?>"> <a class="sample_demo" href="index.php?act=sea_album&op=pic_list&item=goods_image&color_id=<?php echo $output['color_id'];?>" style="display:none;"><?php echo $lang['nc_submit'];?></a>
  ...
  <ul class="list">
    ...
    <li onclick="insert_img('<?php echo $v['apic_cover'];?>','<?php echo sea_thumb($v, 240);?>', <?php echo $output['color_id'];?>);"><a href="JavaScript:void(0);"><img src="<?php echo sea_thumb($v, 240);?>" title='<?php echo $v['apic_name']?>'/></a></li>
    <?php }?>
    <?php }else{?>
