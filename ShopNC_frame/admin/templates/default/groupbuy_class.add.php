  ...
  <form id="add_form" method="post" action="index.php?act=groupbuy&op=class_save">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
            <td colspan="2" class="required"><label>虚拟团购分类:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform">
                <input type="radio" name="is_virtual" id="islimit_1" value="1">
                &nbsp;是&nbsp;
                <input type="radio" name="is_virtual" id="islimit_0" value="0" checked="checked">
                &nbsp;否</td>
