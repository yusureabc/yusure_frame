    ...
    <tbody>
      ...
      <tr>
        <td><ul>
            ...
            <!-- 身份证号码 -->
            <?php if ( $output['order_info']['extend_order_common']['reciver_info']['id_card'] != '' ) { ?>
            <li><strong><?php echo $lang['id_card'];?><?php echo $lang['nc_colon'];?></strong><?php echo @$output['order_info']['extend_order_common']['reciver_info']['id_card'];?></li>
            <?php } ?>
