...
<div class="page">
  ...
  <div class="fixed-empty"></div>
    <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=sea_warehouse&op=<?php echo $output['op'];?>">
    	<input name="house_id" type="hidden" value="<?php echo $output['house_info']['house_id'];?>" />
    	<table class="table tb-type2">
    		...
    		<tr class="noborder">
          	  <td class="vatop rowform"><input type="text" value="<?php if(isset($output['house_info']['house_name'])) echo $output['house_info']['house_name'];?>" name="house_name" id="house_name" class="txt"></td>
        	...
        	<tr class="noborder">
          	  <td class="vatop rowform"><input id="house_sort" name="house_sort" type="text" class="txt" value="<?php echo !isset($output['house_info'])?'255':$output['house_info']['house_sort'];?>" /></td>
        	...
        	<tr class="noborder">
          	  <td class="vatop rowform onoff">
          		<label for="is_audit1" class="cb-enable <?php if($output['house_info']['house_recommend'] == 1){ ?>selected<?php } ?>"><span>是</span></label>
            	<label for="is_audit2" class="cb-disable <?php if($output['house_info']['house_recommend'] == 0){ ?>selected<?php } ?>" ><span>否</span></label>
            	<input id="is_audit1" name="is_recommend" <?php if($output['house_info']['house_recommend'] == 1){ ?>checked<?php } ?> value="1" type="radio">
            	<input id="is_audit2" name="is_recommend" <?php if($output['house_info']['house_recommend'] == 0){ ?>checked<?php } ?> value="0" type="radio">
          	  </td>
          	  <td class="vatop tips">
