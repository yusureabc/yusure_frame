...
$arr = array(
		'top' => array(
			...
			9=> array(
				'args'=>'distribute',
				'text' =>$lang['distribute_tab']),
			10 => array(
				'args'	=>	'community',
				'text'	=>	$lang['community_o2o']),
			11 => array(
				'args' => 'overseas',
				'text' => $lang['overseas_model']),
		),
		'left' =>array(
			0 => array(
				'nav' => 'dashboard',
				...
				'list' => array(
					...
					array('args'=>'index,jingtai,dashboard',				'text'=>'首页静态'),
				)
			),
			1 => array(
				'nav' => 'setting',
				...
				'list' => array(
					...
					array('args'=>'sms,message,setting',			'text'=>$lang['nc_sms_set']),
					...
					array('args'=>'name_setting,setting,setting',			'text'=>$lang['nc_admin_nameset']),
				)
			),
			2 => array(
				'nav' => 'goods',
			...
			3 => array(
				...
				'list' => array(
					...
					array('args'=>'msg_setting,store_msg,store', 			'text'=>$lang['store_msg_setting']),
				)
			),
			4 => array(
				'nav' => 'member',
				...
				'list' => array(
					...
					array('args'=>'addcurrency,currency,member',			'text'=>$lang['nc_member_currency']),
			...
			5 => array(
				...
				'text' => $lang['nc_trade'],
				'list' => array(
					array('args'=>'index,order,trade',				'text'=>'实物订单'),
					array('args'=>'index_virtual,order,trade',				'text'=>'虚拟订单'),
			...
			6 => array(
				...
				'list' => array(
					...
					array('args'=>'channel_column,channel_column,website',			'text'=>$lang['nc_channel_index']),
					array('args'=>'rec_list,rec_position,website',			'text'=>$lang['nc_admin_res_position']),
				    array('args'=>'web_special_list,web_special,website',   'text'=>$lang['nc_cms_special_manage']),
				    array('args'=>'home_ad,home_ad,website',					'text'=>$lang['nc_main_ad']),
				    array('args'=>'home_ad,nc_ad,website',					'text'=>$lang['nc_nc_ad']),
			...
			7 => array(
				...
				'list' => array(
					...
					array('args'=>'index,pd_gift_card,operation',				'text'=>'礼品卡管理'),
					array('args'=>'point_transport_list,point_transport,operation',				'text'=>$lang['transport_tpl']),
				)
			),
			8 => array(
				'nav' => 'stat',
			...
			*/
			array('args'=>'levellist,distribute,distribute',	'text'=>$lang['distribute_level_setting']),
				)
			),
			10 => array(
				'nav' => 'community',
				'text' => $lang['community_o2o'],
				'list' => array(
					// Author  Yusure  2015.6.3
					array('args'=>'arealist,o2o_area,community',			'text'=>$lang['area_list']),
					array('args'=>'village_list,o2o_village,community',		'text'=>$lang['village']),
					// Author  Alina   2015.6.3
					array('args'=>'storelist,merchant,community',			'text'=>$lang['merchant']),
					array('args'=>'storeclass,merchant,community',			'text'=>$lang['merchant_type']),
					array('args'=>'goods,o2o_goods,community',				'text'=>$lang['o2o_goods']),
					array('args'=>'goods_class,o2o_goods_class,community',	'text'=>$lang['o2o_goods_class']),
					array('args'=>'order_list,o2o_order,community',			'text'=>$lang['nc_order_manage']),
					array('args'=>'service_list,o2o_store_service,community',	'text'=>$lang['store_service']),					
					array('args'=>'comment_list,comment,community',			'text'=>$lang['comment']),
					array('args'=>'member_list,distribute_member,community',	'text'=>$lang['distribute_member']),
					array('args'=>'mb_ad_list,o2o_mb_ad,community',	'text'=>$lang['mb_o2o_ad']),
					array('args'=>'mb_o2o_list,o2o_mb_ad,community',	'text'=>$lang['mb_ad']),
				)
			),
		 11 => array(
		 	'nav' => 'overseas',
		 	'text' => $lang['overseas_model'],
		 	'list' => array(
		 		array('args'=>'member_list,overseas_member,overseas',      'text'=>$lang['overseas_member']),              // 海外购用户管理
		 		array('args'=>'article_class,sea_article_class,overseas',  'text'=>$lang['overseas_article_category']),    // 文章分类
		 		array('args'=>'article,sea_article,overseas',              'text'=>$lang['overseas_article']),             // 文章管理
		 		array('args'=>'goods_class,sea_goods_class,overseas',      'text'=>$lang['overseas_goods_category']),      // 商品分类
		 		array('args'=>'add_goods,sea_goods_add,overseas',          'text'=>$lang['overseas_add_goods']),           // 发布商品
		 		array('args'=>'goods,sea_goods,overseas',                  'text'=>$lang['overseas_goods']),               // 商品管理
		 		array('args'=>'brand_list,overseas_brand,overseas',        'text'=>$lang['overseas_brand']),               // 品牌管理
		 		array('args'=>'spec,sea_spec,overseas',                    'text'=>$lang['overseas_specify']),             // 规格管理
		 		array('args'=>'warehouse,sea_warehouse,overseas',          'text'=>$lang['overseas_warehouse']),           // 仓库管理
		 		array('args'=>'index,sea_order,overseas',                  'text'=>$lang['overseas_order']),               // 订单管理
		 		array('args'=>'index,sea_service,overseas',                'text'=>$lang['overseas_service']),             // 海外购客服设置
		 	)
		 )
		)
);
if(C('mobile_isuse')){
	...
	$arr['left'][] = array(
				...
				'list' => array(
					...
					array('args'=>'mb_app_home_list,mb_app_home,mobile',	'text'=>$lang['nc_app_homeset']),
					array('args'=>'mb_category_list,mb_category,mobile',	'text'=>$lang['nc_mobile_catepic']),
					array('args'=>'mb_search_list,mb_search,mobile',         'text'=>$lang['nc_mobile_search']),
					array('args'=>'mb_goods_list,mb_goods,mobile',           'text'=>$lang['nc_mobile_goods']),
					array('args'=>'mb_cl_list,mb_cl,mobile',				'text'=>$lang['nc_mobile_carousel']),	// 体验馆轮播广告
                    array('args'=>'mb_cf_list,mb_cf,mobile', 				'text'=>$lang['nc_mobile_classification']),// 体验馆分类
                    array('args'=>'mb_cn_list,mb_cn,mobile',				'text'=>$lang['nc_mobile_content']),  // 体验馆内容
                    array('args'=>'mb_cloudpush_push,mb_cloudpush,mobile',	'text'=>$lang['nc_mobile_cloudpush']),  // 云推送
                   	array('args'=>'index,shake,mobile',		   				 'text'=>$lang['nc_shake_manage']),
        			array('args'=>'index,signon,mobile',		   			'text'=>$lang['nc_signon_manage']),//积分签到
                    array('args'=>'joke_list,shake_joke,mobile', 			'text'=>$lang['shake_joke'] ),
					array('args'=>'mb_recommendreg,recomreginfo,mobile',				'text'=>$lang['mob_recommend_reg']),  // 推荐注册
					array('args'=>'mb_reglist,mb_regsetting,mobile',	'text'=>$lang['mob_login_ad']),  // 积分签到广告位设置
                    //前台还没坐反馈，暂时隐藏
					// array('args'=>'flist,mb_feedback,mobile',					'text'=>$lang['nc_mobile_feedback'])
					array('args'=>'festival_list,festival,mobile','text'=>$lang['startad']),			//节日设置
					array('args'=>'mobilecollection_list,mobilecollection,mobile','text'=>$lang['mobilecollection']),
					array('args'=>'special_list,mb_special,mobile','text'=>$lang['mb_special']),				
				)
			);
}
