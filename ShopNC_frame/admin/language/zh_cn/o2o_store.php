...
$lang['nc_admin_quick_reason']			= '快捷原因';
$lang['nc_admin_reason_method']			= '原因类型';
$lang['nc_admin_reason_list']			= '原因列表';
$lang['nc_admin_reason_edit']			= '原因编辑';
$lang['nc_admin_add_reason']			= '添加原因';
$lang['nc_admin_reason_type']			= '原因类型';
$lang['reason_help1']					= '管理员添加快捷原因,用户显示各种拒绝原因';
...
$lang['nc_admin_fullfirst_letter']		= '完整首字母';
...
$lang['nc_admin_area_help2']			= '小区管理可以对小区添加，删除，修改，不要忘记填写坐标哦';
...
$lang['nc_admin_area_longitude']		= '区域经纬度';

/*
 *	小区管理
 */
$lang['nc_admin_village_name']			= '小区名称';
$lang['nc_admin_area_choose']			= '地区选择';
$lang['nc_please_choose']				= '请选择';
$lang['nc_admin_village_longitude']		= '小区经纬度';
$lang['nc_admin_village_proportion']	= '小区面积(平方米)';
$lang['nc_admin_village_number']		= '小区人口数(位)';
$lang['nc_admin_village_contacts']		= '小区联系人';
$lang['nc_admin_village_phone']			= '联系电话';
$lang['nc_admin_village_status']		= '小区状态';
$lang['nc_admin_village_remarks']		= '小区备注';
$lang['nc_admin_village_address_info']  = '小区详细地址';
$lang['nc_admin_village_pic']			= '小区展示图';
$lang['village_status_on']				= '启用';
$lang['village_status_check']			= '审核中';
$lang['village_status_reject']			= '驳回';
$lang['village_status_off']				= '关闭';
$lang['village_confirm_off']			= '您确定要关闭吗?';
$lang['village_confirm_examine']		= '您确定要通过审核吗?';
 ...
 *	商家服务
 */
$lang['nc_admin_service_name']			= '服务名称';
$lang['nc_admin_srevice_add']			= '添加';
$lang['nc_admin_srevice_edit']			= '编辑';
$lang['service_help1']					= '管理员添加商家服务供给商家自由选择用于显示在App';
