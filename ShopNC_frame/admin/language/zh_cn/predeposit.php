...
$lang['recharge_pass'] = "提现申请通过";
$lang['recharge_refuse'] = "提现申请驳回";
$lang['pd_memo'] = "备注";
$lang['pd_tip']= '若想拒绝申请,请务必在‘备注’处填写拒绝理由';
$lang['memo_error'] = "备注不能为空，且字数在50个汉字以内";
$lang['mod_status'] = "修改订单状态，将未通过状态该为拒绝";
?>