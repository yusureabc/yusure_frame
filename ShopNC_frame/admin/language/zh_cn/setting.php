...
$lang['parentSettings']   = '主站';
$lang['parentSettings_notice'] = '开启后可使用主站账号登录商城系统';
...
$lang['open_pointshop_isuse'] = '金币中心';
$lang['open_pointshop_isuse_notice'] = '金币中心和金币同时启用后，网站将增加金币中心频道';
$lang['open_pointprod_isuse'] = '金币兑换';
$lang['open_pointprod_isuse_notice'] = '金币兑换、金币功能以及金币中心启用后，平台发布礼品，会员的金币在达到要求时可以在金币中心中兑换礼品';
$lang['points_isuse_notice'] = '金币系统启用后，可设置会员的注册、登录、购买商品送一定的金币';
...
$lang['voucher_allow_notice'] = '代金券功能、金币功能、金币中心启用后，卖家可以申请代金券活动；会员金币达到要求时可以在金币中心兑换代金券；<br>拥有代金券的会员可在代金券所属店铺内购买商品时，选择使用而得到优惠';
...
$lang['site_bank_account_notice']           = '用半角逗号","分隔项目，用半角冒号":"分隔标题和内容，例："银行:中国银行,币种:人民币,账号:xxxxxxxxxxx,姓名:B2B2C,开户行:中国银行XX分行"';
...
$lang['sea_hot_search']                     = '海外购热门搜索';
$lang['ad_setting']			='广告设置';
$lang['field_notice']                       = '热门搜索，将显示在前台搜索框下面，前台点击时直接作为关键词进行搜索，多个关键词间请用半角逗号 "," 隔开';
$lang['ad_notice']                       = '广告词，将显示在手机端搜索框下面，多个广告词间请用半角逗号 "," 隔开';
...
$lang['if_smtp_authentication']  = '使用SMTP协议发送的邮件地址，如 b2b2c@163.com';
$lang['smtp_user_name']          = 'SMTP 身份验证用户名';
$lang['smtp_user_name_tip']      = '如 b2b2c';
$lang['smtp_user_pwd']           = 'SMTP 身份验证密码';
$lang['smtp_user_pwd_tip']       = 'b2b2c@163.com邮件的密码，如 123456';
...
$lang['parent_isuse']   			= '是否启用主站同步登录功能';
$lang['parent_isuse_open']    	 	= '开启';
$lang['parent_isuse_close']    	 	= '关闭';
$lang['parent_appkey']    	 		= '应用密钥';
$lang['parent_appkey_error']    	= '请添加应用密钥';
$lang['parent_function_fail_tip'] = '该功能需要在  php.ini 中 开启 php_curl 扩展，才能使用。';
...
$lang['points_isuse']   		= '金币';
$lang['points_isuse_open']    	= '开启';
$lang['points_isuse_close']    	= '关闭';
$lang['points_ruletip']    		= '金币规则如下';
$lang['points_item']    	 	= '项目';
$lang['points_number']    	 	= '赠送金币';
$lang['points_number_reg']    	= '会员注册';
$lang['points_number_login']    = '会员每天登录';
$lang['points_number_comments']    = '订单商品评论';
$lang['points_number_money']    = '金币转换成预存款';
$lang['points_number_money_min']    = '金币可以送预存款的最低值';
$lang['points_number_money_total']    = '金币转换预存款值';
$lang['points_number_money_min_info']    = '金币达到此值才能送指定的预存款数';
$lang['points_number_money_total_info']    = '达到赠送金币值时，赠送的钱数';
$lang['points_number_order']    = '购物并付款';
$lang['points_number_orderrate']    = '消费额与赠送金币比例';
$lang['points_number_orderrate_tip']    = '例:设置为10，表明消费10单位货币赠送1金币';
$lang['points_number_ordermax']    = '每订单最多赠送金币';
$lang['points_number_ordermax_tip']    = '例:设置为100，表明每订单赠送金币最多为100金币';
...
$lang['ftp_attach_dir_tip'] 	= '远程附件目录的绝对路径或相对于 FTP 主目录的相对路径，如果是根目录请填"/"，非根目录，请保证服务器端该目录已存在，结尾不需要"/"，如"/upload/b2b2c"';
$lang['ftp_access_url_tip'] = '支持 HTTP 和 FTP 协议，结尾不要加斜杠“/”；如果使用 FTP 协议，FTP 服务器必需支持 PASV 模式，为了安全起见，使用 FTP 连接的帐号不要设置可写权限和列表权限。如果是根目录，直接输入域名即可，如“http://www.baidu.com”，如果非根目录，需要填写域名+目录形式，如“http://www.baidu.com/upload/mall”';
...
$lang['seo_set_point_content'] 		= '金币中心商品内容';
$lang['seo_set_atricle_list'] 		= '文章分类列表';
$lang['seo_set_atricle_content'] 	= '文章内容';
$lang['seo_set_insert_tips'] 		= '可用的代码，点击插入';
//金币
$lang['pay_money_name'] 		= '可转换名称';
$lang['trans_money_name'] 		= '不可转换名称';
$lang['pay_money_name_info'] 		= '可与真实货币转换的虚拟货币名称，如：品币';
$lang['trans_money_name_info'] 		= '不可与真实货币转换的虚拟货币名称，如：金币或积分';
...
$lang['sms_type_open']                    = '短信功能开启';
$lang['sms_type_user']                    = '短信用户账号';
$lang['sms_type_pass']                    = '短信用户密码';
$lang['sms_type_key']                    = '短信发送密匙';
$lang['test_sms_tel']                    = '测试接收短信手机号码';
$lang['sms_type_key_tips']                    = '因为短信运用商不一样，如果需要填就填上';
$lang['sms_type_user_tips']                    = '运营商提供的短信用户账号';
$lang['sms_type_pass_tips']                    = '运营商提供的短信用户密码';
$lang['test_sms_send_fail']                    = '测试短信发送成功';
$lang['text_sms_message']                    = '测试短信内容';
$lang['sms_set']                    = '短信配置';
$lang['sms_tpl']                    = '短信模板';
$lang['sms_log']                    = '短信记录';
$lang['sms_smallbuynum']                    = '短信购买最少数量';
$lang['sms_smallbuynum_tips']                    = '每次购买套餐的月数不能少于配置的数量';
$lang['sms_sellprice']                    = '每月短信套餐售价';
$lang['sms_sender_tel']                    = '发送人/手机号码';
$lang['sms_receive_tel']                    = '接收信息用户';
$lang['sms_behavior']                    = '发生行为';
$lang['sms_time']                    = '发送时间';
$lang['is_addpostage']  = "佣金包含邮费";
$lang['get_cash_condition'] = "提现申请最少消费" ;
$lang['get_cash_condition_tip'] = "只有在消费满此金额后，才能申请提现" ;