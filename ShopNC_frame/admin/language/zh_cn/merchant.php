...
$lang['nc_admin_comment_help1']			= '评论管理可以对评论进行删除操作';
$lang['nc_admin_comment_help2']			= '列表显示商铺名称、会员名称、评分、评论内容等信息';
...
$lang['nc_admin_comment_time']	=	'评论时间';
/**
 * 采集评论
 */
$lang['nc_admin_comment_collection']	=	'评论采集';
$lang['nc_admin_comment_setting']		=	'采集设置';
$lang['nc_admin_collection_url']		=	'采集URL—ID';
$lang['nc_admin_collection_web']		=	'采集网站';
$lang['nc_admin_collection_page']		=	'采集页数';
$lang['nc_admin_collection_date']		=	'评论生成日期';
$lang['nc_admin_collection_meituan_help']		=	'美团：http://www.meituan.com/deal/25761993.html 填写 25761993';
$lang['nc_admin_collection_dianping_help']	=	'大众点评：http://t.dianping.com/deal/8598922 填写 8598922';
 ...
 * 配送人员管理
 */
$lang['nc_admin_distribute_member']		= '配送员管理';
$lang['nc_admin_member_mobile']		= '配送员手机号';
$lang['nc_admin_member_name']		= '配送员姓名';
$lang['nc_admin_member_username']		= '配送员账号';
$lang['nc_admin_member_status']		= '状态';
$lang['nc_admin_member_audit']		= '审核';
$lang['nc_admin_member_audit_status']		= '审核状态';
$lang['nc_admin_member_help1']			= '配送人员管理可以对配送员进行审核、修改、冻结等操作';
$lang['nc_admin_member_help2']			= '列表显示配送人员名字、配送员手机号、状态等信息';
$lang['nc_admin_member_audit_wait']		= '待审核';
$lang['nc_admin_member_audit_yes']		= '审核通过';
$lang['nc_admin_member_audit_no']		= '审核未通过';
$lang['nc_admin_member_audit_succ']		= '审核成功';
$lang['nc_admin_member_audit_fail']		= '审核失败';
$lang['nc_admin_member_status1']		= '正常';
$lang['nc_admin_member_status2']		= '冻结';
$lang['nc_admin_member_succ']= '操作成功';
$lang['nc_admin_member_fail']= '操作失败';
$lang['nc_distribution_evaluation']				= '配送评论';
?>
